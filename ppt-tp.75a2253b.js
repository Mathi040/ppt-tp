const e=new URL(import.meta.resolve("av9qO")).toString(),t=new URL(import.meta.resolve("jCRxP")).toString(),n=new URL(import.meta.resolve("2GUiF")).toString();var i={};new URL(i=import.meta.resolve("iR1nw")).toString();var c={};new URL(c=import.meta.resolve("armOJ")).toString();const o=new URL(i).toString(),r=new URL(c).toString(),a={data:{currentGame:{miEleccion:"",cpuEleccion:""},score:{miPuntaje:0,cpuPuntaje:0}},getState:()=>a.data,setScore(e){a.data.score=e,localStorage.setItem("score",JSON.stringify(e))},setCurrent(e){a.data.currentGame=e},listeners:[],subscribe(e){a.listeners.push(e)}},s=[{regExp:/\/$/,handler:function(e){let t=document.createElement("div");return t.classList.add("content"),t.innerHTML=`
        <style>
            c-text {
            color: #009048;
        }
 ...
 j             width: 100px;
    ...
    `,setTimeout(()=>{let t=document.getElementById("button");t?.addEventListener("click",()=>{e("/game")})},0),i}}];function l(e){window.history.pushState({},"",e),d(e)}function d(e){let t=s.find(t=>t.regExp.test(e));if(t){let e=document.querySelector(".main");e&&(e.innerHTML="",e.appendChild(t.handler(l)))}else console.warn(`${e} no  fue encontrado`)}!function(){class i extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}render(){let e,t=document.createElement("style"),n=this.getAttribute("type"),i=this.getAttribute("margin"),c=this.getAttribute("color"),o=this.textContent;switch(c&&(e.style.color=c),n){case"h1":(e=document.createElement("h1")).textContent=o,e.style.margin=`${i}`,t.innerHTML=`
            ...
            *{
            ...
            `,n.setAttribute("type","h3"),i.setAttribute("type","h4"),c.setAttribute("type","h4"),n.setAttribute("margin","0"),i.setAttribute("margin","0 10px 0 0"),c.setAttribute("margin","0 10px 0 0"),n.textContent="Score",i.textContent=`Vos: ${s}`,c.textContent=`Maquina: ${l}`,t.appendChild(n),t.appendChild(i),t.appendChild(c),this.shadow.appendChild(e),this.shadow.appendChild(t)}}customElements.define("c-score",p),localStorage.getItem("score")||localStorage.setItem("score",JSON.stringify(a.getState().score)),document.querySelector(".main");let m=function(){let e=window.location.pathname,t="/ppt-tp";return e.startsWith(t)?e.replace(t,"")||"/":e}();console.log(m),d(m)}();
//# sourceMappingURL=ppt-tp.75a2253b.js.map
