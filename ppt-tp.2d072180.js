...
.jugador > :first-child {
  ...
  `,setTimeout(()=>{e("/resultado")},2e3)}const l=[{regExp:/\/$/,handler:function(e){let t=document.createElement("div");return t.classList.add("content"),t.innerHTML=`
        <style>
            c-text {
            color: #009048;
        }
 ...
 j             width: 100px;
    ...
    `,setTimeout(()=>{let t=document.getElementById("button");t?.addEventListener("click",()=>{e("/game")})},0),i}}];function d(e){window.history.pushState({},"","/ppt-tp"+e),p(e)}function p(e){let t=l.find(t=>t.regExp.test(e));if(t){console.log(e);let n=document.querySelector(".main");n&&(n.innerHTML="",n.appendChild(t.handler(d))),"/game"==e&&s(d)}else console.warn(`${e} no  fue encontrado`)}function m(){let e=window.location.pathname;console.log(e);let t="/ppt-tp";return e.startsWith(t)?e.replace(t,"")||"/":e}!function(){class i extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}render(){let e,t=document.createElement("style"),n=this.getAttribute("type"),i=this.getAttribute("margin"),c=this.getAttribute("color"),o=this.textContent;switch(c&&(e.style.color=c),n){case"h1":(e=document.createElement("h1")).textContent=o,e.style.margin=`${i}`,t.innerHTML=`
            ...
            *{
            ...
            `,n.setAttribute("type","h3"),i.setAttribute("type","h4"),c.setAttribute("type","h4"),n.setAttribute("margin","0"),i.setAttribute("margin","0 10px 0 0"),c.setAttribute("margin","0 10px 0 0"),n.textContent="Score",i.textContent=`Vos: ${s}`,c.textContent=`Maquina: ${l}`,t.appendChild(n),t.appendChild(i),t.appendChild(c),this.shadow.appendChild(e),this.shadow.appendChild(t)}}customElements.define("c-score",d),localStorage.getItem("score")||localStorage.setItem("score",JSON.stringify(a.getState().score)),document.querySelector(".main");let u=m();console.log(u),p(u),window.onpopstate=()=>{p(m())}}();
//# sourceMappingURL=ppt-tp.2d072180.js.map
